...
9. **🛠️ ترسانة الأدوات و (MCP) (`tool_registry.py`)**: 
   - واجهة للربط بين الذكاء الاصطناعي (Function Calling) والأدوات المحلية أو الخوادم التي تدعم معيار **Model Context Protocol (MCP)** لفتح الباب أمام قدرات لانهائية.
